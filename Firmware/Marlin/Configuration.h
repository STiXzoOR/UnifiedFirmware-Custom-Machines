...
//===============================================================================
  ...
  #define CUSTOM_TMC_CURRENT
  #define CUSTOM_X_CURRENT 523
  #define CUSTOM_Y_CURRENT 523
  #define CUSTOM_Z_CURRENT 1050
  #define CUSTOM_E0_CURRENT 523

  #define CUSTOM_STALL_SENSITIVITY
  #define CUSTOM_X_STALL_SENSITIVITY 120
  #define CUSTOM_Y_STALL_SENSITIVITY 120
